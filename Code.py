...
class Code:
    ...
    def game_end(self, player, return_known_code, guess):
        sec = 0.005
        Addons.countdown()
    ...
    Wygląda na to że, aby je otworzyć należy podać odpowiedni kod.""", sec, newline=False)
            if return_known_code() == self.code:
    ...
    def guess(self, player, fight_with_boss):
        print("\nPodaj kod")
        code_input = input(">>>")
